...
export class removeDebtType1658167095284 implements MigrationInterface {
    name = 'removeDebtType1658167095284'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."debts_role_enum" AS ENUM('credito', 'emprestimo')`);
        await queryRunner.query(`CREATE TABLE "debts" ("id" SERIAL NOT NULL, "ipoc" character varying NOT NULL, "debtValue" numeric(10,2) NOT NULL, "debtOrigin" numeric(10,2) NOT NULL, "role" "public"."debts_role_enum" NOT NULL DEFAULT 'credito', "registration" TIMESTAMP NOT NULL DEFAULT now(), "dateDebt" TIMESTAMP NOT NULL DEFAULT now(), "debtStatus" boolean NOT NULL DEFAULT true, "bankId" integer, "clientDocument" bigint, "contactHistoryId" integer, CONSTRAINT "UQ_3f7e06cf1f1749e839819e7da24" UNIQUE ("ipoc"), CONSTRAINT "PK_4bd9f54aab9e59628a3a2657fa1" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."debts_role_enum"`);
