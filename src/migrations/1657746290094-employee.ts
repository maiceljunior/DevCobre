...
export class employee1657746290094 implements MigrationInterface {
    name = 'employee1657746290094'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "client_info" ("id" integer NOT NULL, "telephone" integer NOT NULL, "email" character varying(250) NOT NULL, "clientDocumentDocument" integer, CONSTRAINT "PK_09bdc12b41c346ad56afee8d6cc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "debts" ("id" SERIAL NOT NULL, "debt_value" numeric(10,2) NOT NULL, "document_client" numeric(16) NOT NULL, "ipoc" integer NOT NULL, "debt_origin" numeric(10,2) NOT NULL, "registration" TIMESTAMP NOT NULL DEFAULT now(), "date_debt" TIMESTAMP NOT NULL DEFAULT now(), "bankId" integer, "clientDocument" integer, "debtTypeId" integer, "formOfPaymentId" integer, CONSTRAINT "PK_4bd9f54aab9e59628a3a2657fa1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "client" ("document" integer NOT NULL, "name" character varying(250) NOT NULL, "type" character varying(16) NOT NULL, CONSTRAINT "PK_463cae6774e9b085ca966d89b4f" PRIMARY KEY ("document"))`);
