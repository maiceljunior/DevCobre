...
export class first1658240987144 implements MigrationInterface {
    name = 'first1658240987144'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying(251) NOT NULL, "position" "public"."user_position_enum" NOT NULL DEFAULT 'user', CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "agreement" ("id" SERIAL NOT NULL, "agreedvalue" numeric(10,2) NOT NULL, "dateagree" TIMESTAMP NOT NULL, "status" boolean NOT NULL, "bankId" integer, "clientDocument" character varying(20), "userId" integer, CONSTRAINT "PK_e7537188219eeef56233a609753" PRIMARY KEY ("id"))`);
